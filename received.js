...
async function sendEmail(data) {
    ...
    const transporter = nodemailer.createTransport({
      ...
      ejs.renderFile('C:/Rerouted/received.ejs', data, function (err, ejs) { //reads over the empty template and injects the data into the template. Then calls callback function to send finished template
        if (err) {
            console.log(err);
        } else {
            var mainOptions = {
...
webhook subscription sending multiple triggers even though only activated once
*/